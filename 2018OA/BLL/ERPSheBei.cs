...
namespace ZWL.BLL
{
	...
	public class ERPSheBei
	{
        ...
        /// 设备品牌
        /// </summary>
        public string SheBeiBrand
        {
            set { _shebeibrand = value; }
            get { return _shebeibrand; }
        }
         /// <summary>
        /// 购买日期
        /// </summary>
        ...
        public string MAC
 {
		...
		public ERPSheBei(int ID)
		{
			...
			if(ds.Tables[0].Rows.Count>0)
			{
                ...
                SheBeiBrand=ds.Tables[0].Rows[0]["SheBeiBrand"].ToString();
                BuyDate=ds.Tables[0].Rows[0]["BuyDate"].ToString();
                MaintenanceDate=ds.Tables[0].Rows[0]["MaintenanceDate"].ToString();
                OS=ds.Tables[0].Rows[0]["OS"].ToString();
                VLAN=ds.Tables[0].Rows[0]["VLAN"].ToString();
                IP=ds.Tables[0].Rows[0]["IP"].ToString();
                MAC=ds.Tables[0].Rows[0]["MAC"].ToString();
		...
		public int Add()
		{
			...
			SqlParameter[] parameters = {
                    ...
                    new SqlParameter("SheBeiBrand",SqlDbType.VarChar,50),
                    new SqlParameter("BuyDate",SqlDbType.VarChar,50),
                    new SqlParameter("MaintenanceDate",SqlDbType.VarChar,50),
                    new SqlParameter("OS",SqlDbType.VarChar,50),
                    new SqlParameter("VLAN",SqlDbType.VarChar,50),
            ...
            parameters[38].Value = SheBeiBrand;
            parameters[39].Value = BuyDate;
            parameters[40].Value = MaintenanceDate;
            parameters[41].Value = OS;
            parameters[42].Value = VLAN;
            parameters[43].Value = IP;
            parameters[44].Value = MAC;
		...
		public void Update()
		{
            ...
            strSql.Append("SheBeiBrand=@SheBeiBrand,");
			...
			parameters[38].Value = TimeStr;
             parameters[39].Value=SheBeiBrand;
            parameters[40].Value=BuyDate;
            parameters[41].Value=MaintenanceDate;
            parameters[42].Value=OS;
            parameters[43].Value=VLAN;
            parameters[44].Value=IP;
            parameters[45].Value=MAC;
