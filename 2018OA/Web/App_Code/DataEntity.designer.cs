...
public partial class ERPSheBei : INotifyPropertyChanging, INotifyPropertyChanged
{
    ...
    partial void OnSheBeiBrandChanging(string value);
    partial void OnSheBeiBrandChanged();
	...
	[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SheBeiBrand", DbType="VarChar(50)")]
	public string SheBeiBrand
	{
		get
		{
			return this._SheBeiBrand;
		}
		set
		{
			if ((this._SheBeiBrand != value))
			{
				this.OnSheBeiBrandChanging(value);
				this.SendPropertyChanging();
				this._SheBeiBrand = value;
				this.SendPropertyChanged("SheBeiBrand");
				this.OnSheBeiBrandChanged();
			}
		}
	}
