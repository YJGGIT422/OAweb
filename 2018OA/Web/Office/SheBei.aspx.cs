...
public partial class Office_SheBei : System.Web.UI.Page
{
	...
	protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
	{
		...
		MyTable.Add("YuanBianHao", "维修服务编号");
        ...
        MyTable.Add("ShengChanChangJia", "供货商");
        ...
        MyTable.Add("IP", "IP");
        MyTable.Add("VLAN", "VLAN");
        MyTable.Add("MAC", "MAC");
        MyTable.Add("OS", "操作系统");
        MyTable.Add("BuyDate", "购买日期");
        MyTable.Add("MaintenanceDate", "维保日期");
		...
		ZWL.Common.DataToExcel.GridViewToExcel(ZWL.DBUtility.DbHelperSQL.GetDataSet("select  YuanBianHao,SheBeiName,SheBeiLeiBie,XingHao,ChuChangBianHao,ShengChanChangJia,DanWei,DanJia,IP,VLAN,MAC,OS,BuyDate,MaintenanceDate,QiYongDate,ShiYongBuMen,GuanLiUser,CunFangAddr,ZhuangTai,BeiZhu,TiXingDate,TiXingUser  from ERPSheBei where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
	}
