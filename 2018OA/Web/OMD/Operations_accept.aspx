<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Operations_accept.aspx.cs" Inherits="Operations_accept" %>
<html>
	<head>
		<title><%=System.Configuration.ConfigurationManager.AppSettings["SYSTitle"]%></title>
  <LINK href="../Style/Style.css" type="text/css" rel="STYLESHEET">
         <meta http-equiv="refresh" content="10"  URL="Operations_accept.aspx"/>
</head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;运维受理
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:BoundField DataField="FauleEquipment" HeaderText="故障设备编码" HeaderStyle-Width="100px" ></asp:BoundField>  
					<asp:BoundField DataField="EquipmentName" HeaderText="故障设备" HeaderStyle-Width="50px" ></asp:BoundField>     
					<asp:BoundField DataField="Phenomenon" HeaderText="故障现象" HeaderStyle-Width="400px"  ></asp:BoundField>       
					<asp:BoundField DataField="CunFangAddr" HeaderText="存放位置" HeaderStyle-Width="100px" ></asp:BoundField>
          ...
          <ItemTemplate>
                ...
                <a href="#"  onclick="javascript:window.open('accept.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ID")%>','_self');"><asp:Image ID="Image3" runat="server"  ImageUrl="../images/Button/accept.gif"  ToolTip="受理" /></a> 
              &nbsp;&nbsp;
              <a href="#"  onclick="javascript:window.open('Rejected.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ID")%>','_self');"><asp:Image ID="Image1" runat="server"  ImageUrl="../images/Button/refused.gif"  ToolTip="驳回" /></a> 
         </ItemTemplate>
        </asp:TemplateField>
