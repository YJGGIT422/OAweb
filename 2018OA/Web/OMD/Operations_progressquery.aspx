<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Operations_progressquery.aspx.cs" Inherits="Operations_progressquery" %>
<html>
	<head>
		<title><%=System.Configuration.ConfigurationManager.AppSettings["SYSTitle"]%></title>
  <LINK href="../Style/Style.css" type="text/css" rel="STYLESHEET">
         <meta http-equiv="refresh" content="10" URL="Operations_progressquery.aspx"/>
</head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;进度查询
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <asp:BoundField DataField="RepairPeople" HeaderText="报修人" HeaderStyle-Width="30px"  ></asp:BoundField>    
                        <asp:BoundField DataField="RepairDate" HeaderText="报修时间" HeaderStyle-Width="30px"  ></asp:BoundField>     
					...
					<asp:TemplateField HeaderText="状态"   HeaderStyle-Font-Size="12px"  ItemStyle-Width="45px"   ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                     <ItemTemplate>
