<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Operations_registration_result.aspx.cs" Inherits="Operations_registration_result" %>
<html>
	<head>
		<title><%=System.Configuration.ConfigurationManager.AppSettings["SYSTitle"]%></title>
  <LINK href="../Style/Style.css" type="text/css" rel="STYLESHEET">
        <meta http-equiv="refresh" content="10" URL="Operations_registration_result.aspx"/>
</head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;结果登记
                </td>
