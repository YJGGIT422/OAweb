<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Operations_dispatching.aspx.cs" Inherits="Operations_dispatching" %>
<html>
	<head>
		<title><%=System.Configuration.ConfigurationManager.AppSettings["SYSTitle"]%></title>
  <LINK href="../Style/Style.css" type="text/css" rel="STYLESHEET">
        <meta http-equiv="refresh" content="10" URL="Operations_dispatching.aspx"/>
</head>
    ...
    <div> 
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;运维派工
                </td>
        ...
        <table style="width: 100%">
          ...
          <ItemTemplate>
                ...
                <a href="#"  onclick="javascript:window.open('dispatching.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ID")%>','_self');"><asp:Image ID="Image3" runat="server"  ImageUrl="../images/Button/dispatching.gif"  ToolTip="派工" /></a> 
             </ItemTemplate>
        </asp:TemplateField>
