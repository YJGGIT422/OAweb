<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Demand_Check.aspx.cs" Inherits="OMD_Demand_Demand_Check" %>
...
<div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;需求审核
                </td>
        ...
        <table style="width: 100%">
          ...
          <ItemTemplate>
              ...
              <a href="#"  onclick="javascript:leftVal = (screen.width - 300) / 2;topVal = (screen.height - 500) / 2;window.open('MessageBox.aspx?Number=<%# DataBinder.Eval(Container.DataItem, "Number")%>','_blank','width=450,height=150,toolbars=yes,resizable=yes,scrollbars=yes,left='+leftVal+',top='+topVal);"><asp:Image ID="Image3" runat="server"  ImageUrl="../../images/Button/Auditor.jpg"  ToolTip="审核" /></a> 
              &nbsp;&nbsp;
        ...
        <asp:Label ID="masege" runat="server"></asp:Label>
    </form>
</body>
</html>
