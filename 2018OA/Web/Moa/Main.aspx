<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Main.aspx.cs" Inherits="Moa_Main" %>
...
<body>
    ...
    <div id="content">
        ...
        <ul class="pageitem">
            <li class="textbox"><span class="header">欢迎,<%= ZWL.Common.PublicMethod.GetSessionValue("UserName")%></span><p>
                欢迎来到移动办公平台（手机版）</p>
            </li>
            <%=menus %>
        </ul>
    ...
    <div id="footer">
        <a href="http://jinmapu.taobao.com" target="_blank">Powered by </a></div>
