    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                {
                    //序列号错误
                    //ZWL.Common.MessageBox.ShowAndRedirect(this, "系统授权码验证无效！请联系临床工程信息部取授权！", "SerilsSetting.aspx");
                }
            }
            catch
            {
            ...
            try
            {
                ...
                //{
                    //使用时间到达
                    //ZWL.Common.MessageBox.ShowAndRedirect(this, "系统授权码过期！请联系临床工程信息部取授权！", "SerilsSetting.aspx");
                //}
            }
            catch
            {
