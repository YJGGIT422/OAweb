<%@ page language="C#" autoeventwireup="true" inherits="SelectCondition, App_Web_a1vottkp" %>
                ...
                <table border="0" cellspacing="0" cellpadding="0" style="width: 318px; height: 49px">
                    <tr>
                        <td colspan="2" style="height: 31px; text-align: left">
                            部&nbsp; 门：<asp:TextBox ID="TextBox2" runat="server" Height="20px" Width="85px"></asp:TextBox>
