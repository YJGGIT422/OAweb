<%@ page language="C#" autoeventwireup="true" inherits="SelectCondition, App_Web_44jxn1si" %>
    ...
    <div id="content">
        <ul class="pageitem">
            <li class="button" style="text-align: center;">部门：<asp:TextBox ID="TextBox2" runat="server"
                ...
                角色：<asp:TextBox ID="TextBox3" runat="server" Height="20px" Width="50px"></asp:TextBox><img
                    ...
                    <tr>
                        ...
                        <td style="width: 27px">
                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../images/AddTo.gif"
                                OnClick="ImageButton1_Click" ToolTip="选中加入" />
                        </td>
