<%@ page language="C#" autoeventwireup="true" inherits="DocFile_TiKuKaoShiAdd, App_Web_bkr2h1zh" %>
...
<body>
    ...
    <div>
        ...
        <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
            <tr>
                <td style="width: 10%; height: 25px; background-color: #D6E2F3" align="right">
                    请选择试卷：
                </td>
                ...
                <td style="padding-left: 5px; height: 25px; width: 80%; background-color: #ffffff">
                    <asp:Panel ID="Panel1" runat="server" Height="25px" Width="80%" Visible="False">
                        <div id="timer" style="color: red; font-weight: bold;">
                        </div>
                    </asp:Panel>
                </td>
            </tr>
