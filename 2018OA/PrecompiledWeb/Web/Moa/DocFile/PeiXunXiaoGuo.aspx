<%@ page language="C#" autoeventwireup="true" inherits="DocFile_PeiXunXiaoGuo, App_Web_bikuevrl" %>
    ...
    <div id="content">
        <ul>
            <%
                ...
                {
            %>
            <li><a class="effect" href="PeiXunXiaoGuoView.aspx?ID=<%=item.ID %>"><span class="image"
                style="background-image: url('../Style/Mobile/thumbs/rmail.png')"></span><span class="comment">
                    <%=item.UserName%></span> <span class="name">
                        <%=item.FanKuiZhuTi%></span> <span class="stars4"></span><span class="arrow">
