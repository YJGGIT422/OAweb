<%@ page language="C#" autoeventwireup="true" inherits="NetMail_NetMailCao, App_Web_lvjgqcw4" %>
    ...
    <div id="content">
        <ul>
            <%
                ...
                {
            %>
            <li><a class="effect" href="NetEmailView.aspx.aspx?ID=<%=item.ID %>"><span class="image"
