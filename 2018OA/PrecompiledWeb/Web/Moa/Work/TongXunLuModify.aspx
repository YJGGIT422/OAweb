<%@ page language="C#" autoeventwireup="true" inherits="Work_TongXunLuModify, App_Web_q5kqsoer" %>
<html>
	<head>
    ...
    <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">            
        ...
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #cccccc">
                生日：</td>
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                <asp:TextBox id="TextBox4" runat="server" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" Width="350px" ></asp:TextBox></td>
        </tr>
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #cccccc">
                昵称：</td>
