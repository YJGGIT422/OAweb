<%@ page language="C#" autoeventwireup="true" inherits="LanEmail_LanEmailShou, App_Web_l1a1xqff" %>
    ...
    <div id="content">
        <ul>
            <%
                ...
                {
            %>
            <li><a class="effect" href="EmailView.aspx?ID=<%=item.ID %>"><span class="image" <%if(item.EmailState=="未读") {%>
                style="background-image: url('../Style/Mobile/thumbs/mail.png')" <%}else{ %>style="background-image: url('../Style/Mobile/thumbs/rmail.png')"
