<%@ page language="C#" autoeventwireup="true" inherits="Subaltern_SubRiZhi, App_Web_ctlifmnh" %>
<html>
	<head>
    ...
    <div id="content">
        <ul>
            <%
                ...
                {
            %>
            <li><a class="effect" href="../Work/WorkRiZhiView.aspx?ID=<%=item.ID %>"><span class="image"
