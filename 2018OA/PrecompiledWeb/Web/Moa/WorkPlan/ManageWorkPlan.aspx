<%@ page language="C#" autoeventwireup="true" inherits="WorkPlan_ManageWorkPlan, App_Web_i2s3otd3" %>
        ...
        <ul>
            <%
                if (EmailList.Count > 0)
                {
                    ...
                    {
            %>
            <li><a class="effect" href="WorkPlanView.aspx?ID=<%=item.ID %>"><span class="image"
