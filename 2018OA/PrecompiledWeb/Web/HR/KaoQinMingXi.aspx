<%@ page language="C#" autoeventwireup="true" inherits="HR_KaoQinMingXi, App_Web_rh3bqq3d" %>
<html>
	<head>
         ...
         <tr>
             <td colspan="2" style="border-bottom: #006633 1px dashed; height: 30px" valign="middle">
                 &nbsp; &nbsp; 用户名：<asp:TextBox ID="TextBox1" runat="server" Height="20px" Width="80px"></asp:TextBox><img
                     ...
                     src="../images/Button/search.gif" />&nbsp; 起至日期：<asp:TextBox id="TextBox2" runat="server" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" Width="80px" ></asp:TextBox> ~ <asp:TextBox id="TextBox3" runat="server" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" Width="80px" ></asp:TextBox>
