<%@ page language="C#" autoeventwireup="true" inherits="NWorkFlow_NFormDesign, App_Web_yveem5xh" %>
...
else if(str=="1")
{
   ...
   editor.execCommand("insertHtml",'<input id=Text'+cValue+'  name="Text'+cValue+'" alt="'+document.getElementById("TextBox5").value+'"  type="text"  style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px solid #000000"/>');
...
else if(str=="13")
{
   ...
   editor.execCommand("insertHtml",'<input id=Date'+cValue+' name="Date'+cValue+'" alt="'+document.getElementById("TextBox8").value+'"    type="text"  onclick="setday(this)"   value=""  style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="4")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id=Text'+cValue+' name="Text'+cValue+'" alt="'+document.getElementById("TextBox1").value+'" type="text" value="宏控件-用户姓名" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="5")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id=Text'+cValue+' name="Text'+cValue+'" alt="'+document.getElementById("TextBox3").value+'" type="text" value="宏控件-用户部门" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="6")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id=Text'+cValue+'  name="Text'+cValue+'" alt="'+document.getElementById("TextBox4").value+'"  type="text" value="宏控件-用户角色" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="7")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id=Text'+cValue+'  name="Text'+cValue+'" alt="'+document.getElementById("TextBox10").value+'" type="text" value="宏控件-用户职位" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="8")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id=Text'+cValue+'  name="Text'+cValue+'" alt="'+document.getElementById("TextBox12").value+'" type="text" value="宏控件-当前日期" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="101")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id=Text'+cValue+'  name="Text'+cValue+'" alt="'+document.getElementById("TextBox13").value+'" onclick="selectUser(Text'+cValue+');"  type="text" value="点击选择用户" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="102")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id="Text'+cValue+'"  name="Text'+cValue+'" alt="'+document.getElementById("TextBox14").value+'" onclick="selectBuMen(Text'+cValue+');"  type="text" value="点击选择部门" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="103")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id=Text'+cValue+'  name="Text'+cValue+'"  alt="'+document.getElementById("TextBox15").value+'" type="text" value="宏控件-部门主管" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
