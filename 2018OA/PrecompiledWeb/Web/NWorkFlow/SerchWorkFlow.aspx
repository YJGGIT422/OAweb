<%@ page language="C#" autoeventwireup="true" inherits="NWorkFlow_SerchWorkFlow, App_Web_yveem5xh" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					...
					OnClick="ImageButton4_Click" /><asp:ImageButton ID="ImageButton6" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/ResultSerch.jpg" OnClick="ImageButton6_Click" />&nbsp; &nbsp; &nbsp;<asp:ImageButton ID="ImageButton5" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnChaoSong.jpg"
                        OnClick="ImageButton5_Click" OnClientClick="javascript:return CheckModify();" />&nbsp;<asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="../images/Button/BtnReport.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton2_Click" /><img src="../images/Button/JianGe.jpg" /><img class="HerCss" onclick="javascript:window.history.go(-1)" src="../images/Button/BtnExit.jpg" />&nbsp;</td>
            </tr>
        </table>
