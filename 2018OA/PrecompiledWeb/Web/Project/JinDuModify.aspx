<%@ page language="C#" autoeventwireup="true" inherits="Project_JinDuModify, App_Web_qhy2yerh" %>
<html>
	<head>
...
<table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
		<asp:TextBox id="txtStartTime" runat="server" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" Width="350px" ></asp:TextBox></asp:TextBox><asp:RangeValidator
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
		...
		<asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="txtEndTime" Display="Dynamic"
            ErrorMessage="*日期格式不正确" MaximumValue="2099-01-01" MinimumValue="1900-01-01" Type="Date"></asp:RangeValidator><asp:RequiredFieldValidator
