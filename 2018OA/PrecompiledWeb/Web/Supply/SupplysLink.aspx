<%@ page language="C#" autoeventwireup="true" inherits="Supply_SupplysLink, App_Web_0tqa2kva" %>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    时间：<asp:TextBox id="TextBox3" runat="server" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" Width="350px" ></asp:TextBox>至<asp:TextBox id="TextBox4" runat="server" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" Width="350px" ></asp:TextBox>
