<%@ page language="C#" autoeventwireup="true" inherits="Subaltern_TaskFPAdd, App_Web_jgvzgqqh" %>
    ...
    <div>
        ...
        <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
            ...
            <tr>
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    <asp:TextBox id="TextBox2" runat="server" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" Width="350px" ></asp:TextBox>
            ...
            <tr>
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    <asp:TextBox id="TextBox3" runat="server" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" Width="350px" ></asp:TextBox>&nbsp;<asp:DropDownList ID="DropDownList3" runat="server">
                            <asp:ListItem>00</asp:ListItem>
                            <asp:ListItem>01</asp:ListItem>
                            <asp:ListItem>02</asp:ListItem>
                            <asp:ListItem>03</asp:ListItem>
            ...
            <tr>
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    ...
                    <asp:TextBox id="TextBox4" runat="server" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" Width="350px" ></asp:TextBox>&nbsp; &nbsp;<asp:DropDownList ID="DropDownList5"
                            runat="server">
                            <asp:ListItem>00</asp:ListItem>
                            <asp:ListItem>01</asp:ListItem>
                            <asp:ListItem>02</asp:ListItem>
