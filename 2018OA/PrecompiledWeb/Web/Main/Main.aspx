<%@ page language="C#" autoeventwireup="true" inherits="Main, App_Web_4fgu1aqm" %>
    ...
    <div>
        ...
        ({
            ...
            items:
             ...
             {
                 xtype: 'tbbutton',
                 text: '当前用户： <font color="black"><%= ZWL.Common.PublicMethod.GetSessionValue("TrueName")%>(<%= ZWL.Common.PublicMethod.GetSessionValue("JiaoSe")%>)</font>',
                 cls: 'x-btn-text-icon',
