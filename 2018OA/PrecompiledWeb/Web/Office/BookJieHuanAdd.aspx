<%@ page language="C#" autoeventwireup="true" inherits="Office_BookJieHuanAdd, App_Web_xersfmjv" %>
<html>
	<head>
...
<table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
    ...
    <tr>
        ...
        <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
            <asp:TextBox id="txtJieShuDate" runat="server" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" Width="350px" ></asp:TextBox></td>
    </tr>
    <tr>
        <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3">
            归还日期：
        ...
        <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
            <asp:TextBox id="txtGuiHuanDate" runat="server" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" Width="350px" ></asp:TextBox></td>
    </tr>
    <tr>
        <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3">
            借还状态：
